...
minetest.register_node("mt_buildings:hut01", {
  ...
  tiles = {"GunsFREE.png"},
  inventory_image = "hut_inv_armory.png",
  wield_image = "hut_inv_armory.png",
  buildable_to = false,
  paramtype = "light",
  paramtype2 = "facedir",
...
minetest.register_node("mt_buildings:hut02", {
  ...
  use_texture_alpha = true,
  tiles = {"MedicFREE.png"},
  inventory_image = "hut_inv_medic.png",
  wield_image = "hut_inv_medic.png",
  buildable_to = false,
  paramtype = "light",
  paramtype2 = "facedir",
  groups = {choppy=2, oddly_breakable_by_hand=2, flammable=3},
...
minetest.register_node("mt_buildings:hut03", {
  ...
  use_texture_alpha = true,
  tiles = {"ShopFREE.png"},
  inventory_image = "hut_inv_shop.png",
  wield_image = "hut_inv_shop.png",
  buildable_to = false,
  paramtype = "light",
  paramtype2 = "facedir",
  groups = {choppy=2, oddly_breakable_by_hand=2, flammable=3},
...
minetest.register_node("mt_buildings:hut04", {
  ...
  inventory_image = "hut_inv_cottage.png",
  wield_image = "hut_inv_cottage.png",
  buildable_to = false,
  paramtype = "light",
  paramtype2 = "facedir",
  groups = {choppy=2, oddly_breakable_by_hand=2, flammable=3},
